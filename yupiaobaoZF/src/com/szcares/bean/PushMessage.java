...
public class PushMessage implements java.io.Serializable {
	...
	private static final long serialVersionUID = -606663236940891241L;
	...
	public String toString() {
		return "PushMessage [detectionMethod=" + detectionMethod
				+ ", extendAccessNum=" + extendAccessNum + ", messageContent="
				+ messageContent + ", messageType=" + messageType
				+ ", orderNo=" + orderNo + ", orgId=" + orgId
				+ ", paymentAmount=" + paymentAmount + ", paymentMethod="
				+ paymentMethod + ", pushDateTime=" + pushDateTime
				+ ", scheduleTime=" + scheduleTime + ", userNumber="
				+ userNumber + "]";
	}
